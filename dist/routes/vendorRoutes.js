...
router.route("/admin/vendors").get(isAuthenticatedVendor, authorizeRoles1("admin"), getAllVendor);
router.route("/admin/vendor/:id").get(isAuthenticatedVendor, authorizeRoles1("admin"), getSingleVendor)
